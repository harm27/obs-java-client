...
import nl.harm27.obswebsocket.api.events.streaming.*;
...
public abstract class StreamingEventListener implements EventListener {
    ...
    public final Map<EventType, Class<?>> getSupportedEvents() {
        ...
        supportedEvents.put(STREAM_STATUS, StreamStatus.class);
    ...
    public final void callEvent(BaseEvent baseEvent) {
        switch (baseEvent.getEventType()) {
            ...
            case STREAM_STOPPED:
                ...
                break;
            case STREAM_STATUS:
                streamStatus((StreamStatus) baseEvent);
                break;
            default:
     ...
     *
     * @param streamStatus The received event.
     */
    public void streamStatus(StreamStatus streamStatus) {
    }
}